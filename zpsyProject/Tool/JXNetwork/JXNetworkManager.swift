...
//    }
    ...
    override init() {
        ...
        afmanager.requestSerializer.setValue("2", forHTTPHeaderField: "platform")
        afmanager.requestSerializer.setValue("1", forHTTPHeaderField: "client")
        afmanager.requestSerializer.setValue(String(format: "%@%@", Utility.getCurrentDeviceModel(),Utility.systemVersionString()), forHTTPHeaderField: "os")
        afmanager.requestSerializer.setValue(Utility.getCurrentDeviceModel(), forHTTPHeaderField: "mobileType")
        afmanager.requestSerializer.setValue(CTUtility.getAppVersion(), forHTTPHeaderField: "version")
        afmanager.requestSerializer.setValue(KeyChainMethod.getUniqueDeviceIdentifierAsString(), forHTTPHeaderField: "uuid")
        afmanager.requestSerializer.setValue(Utility.getUaString(), forHTTPHeaderField: "ua")
        afmanager.requestSerializer.setValue("iOS", forHTTPHeaderField: "source")

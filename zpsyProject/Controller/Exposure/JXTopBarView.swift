...
//    }
    ...
    @objc func tabButtonAction(button : UIButton) {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            var frame1 = self.bottomLineView.frame
            frame1.origin.x = button.jxWidth * index;
            self.bottomLineView.frame = frame1
...
class TopBarAttribute: NSObject {
    var normalColor = JX333333Color
    var highlightedColor = JXMainColor
    var separatorColor = UIColor.groupTableViewBackground
    
    
    
    override init() {
        normalColor = JX333333Color
        highlightedColor = JXMainColor

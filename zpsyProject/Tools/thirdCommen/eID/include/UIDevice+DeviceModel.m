...
+(NSString *)iphonesize{
    NSString *device =[[UIDevice  currentDevice]deviceModel];
    
    if ([device isEqualToString:@"iPhone 4S"]) {
        NSString *iphonesize = @"3.5";
        return iphonesize;
    }else if ([device isEqualToString:@"iPhone 5S"] || [device isEqualToString:@"iPhone 5"] || [device isEqualToString:@"iPhone 5C"] ||[device isEqualToString:@"iPhone SE"]){
        NSString *iphonesize = @"4.0";
        return iphonesize;
    }else if ([device isEqualToString:@"iPhone 6"] || [device isEqualToString:@"iPhone 6S"]){
        NSString *iphonesize = @"4.7";
        return iphonesize;
    }else if ([device isEqualToString:@"iPhone 6S Plus"] ||[device isEqualToString:@"iPhone 6 Plus"]){
        NSString *iphonesize = @"5.5";
        return iphonesize;
    }
    return @"5.5";
}
